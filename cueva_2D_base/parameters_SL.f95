module parameters
    ...
    integer,parameter  :: TEST            = 9  ! look down the number assigned for each test
...
!____________________________________
  ...
  !     NewRaph ---> nr
    ...
    ! -----------------
    !   Conductivity
    doubleprecision,parameter :: sigma_0   =  1.d9
    ...
    doubleprecision,parameter :: B0        =  sqrt(0.d0)
    doubleprecision,parameter :: V0        =  1.d-5 
    doubleprecision,parameter :: P_up      =  1.d-4
    doubleprecision,parameter :: P0        =  1.d-4
    ...
    doubleprecision,parameter                   :: Delt_loc = 1.d1   !
