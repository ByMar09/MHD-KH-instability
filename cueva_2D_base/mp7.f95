      ...
      subroutine MP7(imp5)  !Sergio: 03/07/17
...
!*
       ...
       doubleprecision, parameter :: b1 = 1.d0/420.d0, b2 = 4.d0/3.d0, epsm = 1.d-10, alpha_mp = 2.d0 !   alpha_mp = 1.d0/3.d0 ! original alpha_mp =2.d0 ! MP7
...
!*        Original (unlimited) "left" interface value at i+1/2 (SH97; Eq. 2.31a)
            vorp(imp,jmp,imp5) = b1*(-3.d0 * u(im3,jmp,imp5) + 25.d0  * u(im2,jmp,imp5) -101.d0 * u(im1,jmp,imp5)  &
                                   +319.d0 * u(i0 ,jmp,imp5) + 214.d0 * u(ip1,jmp,imp5) -38.d0  * u(ip2,jmp,imp5)  &
                                   +  4.d0 * u(ip3,jmp,imp5) )
!*        Original (unlimited) "right" interface value at i-1/2 (mirror of Eq. 2.31b)
            vorm(imp,jmp,imp5) = b1*(-3.d0 * u(ip3,jmp,imp5) + 25.d0  * u(ip2,jmp,imp5) -101.d0 * u(ip1,jmp,imp5)  &
                                   +319.d0 * u(i0 ,jmp,imp5) + 214.d0 * u(im1,jmp,imp5) -38.d0  * u(im2,jmp,imp5)  &
                                   +  4.d0 * u(im3,jmp,imp5) )
