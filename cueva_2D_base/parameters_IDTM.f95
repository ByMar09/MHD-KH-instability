...
!____________________________________
  ...
  !     NewRaph ---> nr
    ...
    doubleprecision,parameter :: B0        =  1.d0
    doubleprecision,parameter :: V0        =  0.d0 
    doubleprecision,parameter :: P_up      =  B0**2/2.d0
    doubleprecision,parameter :: P0        =  B0**2/2.d0
    ...
    ! IDTM  current sheet width a an sepration current sheets l
    
    doubleprecision,parameter ::  a_tm     =  0.05d0
    doubleprecision,parameter ::  l_tm     =  5.d0 * a_tm   !OJO CMBIAR
    ...
    ! fit constants for l_tm/a_tm (see Baty (2017))
    
    doubleprecision,parameter ::  a_rdtm   = 0.55d0 !OJO CAMBIAR
    doubleprecision,parameter ::  b_rdtm   = 0.45d0 !OJO CAMBIAR
    ...
    ! Reconection lenght Lr
    
    doubleprecision,parameter ::  Lr       =  S_l**( 9.d0/29.d0) * a_tm

    !   Conductivity
    
    doubleprecision,parameter :: sigma_0   =  S_l/(Lr * VA_rec_tearing)
    doubleprecision,parameter :: sigma_1   =  sigma_0/1.d1
    doubleprecision           :: sigma     =  sigma_0   


    
    !   Linquist Number Sa
    
    doubleprecision,parameter ::  S_a      =  a_tm * VA_rec_tearing * sigma_0 !for this simulation Sa= 6578.95
    ...
    doubleprecision,parameter ::  Ly       =  2.d0 * Lr

    doubleprecision,parameter ::  k_tm     =   modes * 2.d0 * pi / Ly ! two modes in the box
