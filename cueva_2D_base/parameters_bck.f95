module parameters
    ...
    integer,parameter  :: DIM             = 1  ! use 1 for 1D,  2 for 2D and 3 for 3D
    integer,parameter  :: fix             = 1  ! use 1 for fix loop counter in 1D tests and 0 for 2D and 3D tests
    integer,parameter  :: TEST            = 1 ! look down the number assigned for each test
...
!____________________________________
  ...
  !     NewRaph ---> nr
    ...
    doubleprecision,parameter :: V0        =  0.5d0 
    ...
    doubleprecision,parameter :: gamma = 5.d0/3.d0 
    ...
    doubleprecision,parameter :: sigma_0   =  1.d2
