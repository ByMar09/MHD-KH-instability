  module parameters
    ...
    integer,parameter  :: TEST            = 4  ! look down the number assigned for each test
    ...
    integer,parameter  :: flux_solver     = 6  ! use 1 for Simpler Lax-Friederich, 2 for HLL reconstruction flux, 3 for HLLC_1, 4 for HLLC_2 , 5 for HLL + MP5, 6 for HLLC_1 + MP5 and 7 HLLC_2 + MP5
...
!____________________________________
  ...
  ! max values of
    ...
    doubleprecision,parameter                   :: Longy = 1.d0 !0.9975d0 
    ...
    doubleprecision,parameter :: gamma = 5.d0/3.d0 !2.d0 ! 4.d0/3.d0 !        monatomic gas    !  diatomic gas  !  !cp/cv  !
