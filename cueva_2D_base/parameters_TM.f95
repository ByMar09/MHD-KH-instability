module parameters
    ...
    integer,parameter  :: TEST            = 32 ! look down the number assigned for each test
...
!____________________________________
  ...
  !     NewRaph ---> nr
    ...
    !   Linquist Number                                                                                                                                                                                            
    doubleprecision,parameter ::  S_l      =  1.d6 
    ...
    !   Simulation domine                                                                                                                                                                                          
    doubleprecision,parameter ::  Lr       =  1.d0
    doubleprecision,parameter ::  a_tm     =  S_l**(-1./3.) * Lr
    doubleprecision,parameter ::  l_tm     =  5.d0 * a_tm !for DTM
    doubleprecision,parameter ::  k_tm     =  12.d0 ! OJO  CAMBIAR
    doubleprecision,parameter ::  kap_tm   =  k_tm * a_tm
    doubleprecision,parameter ::  Lx       =  40.d0 * a_tm 
    doubleprecision,parameter ::  Ly       =  2.d0 * pi / k_tm 
