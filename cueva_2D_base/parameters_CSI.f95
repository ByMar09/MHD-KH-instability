  module parameters
    ...
    integer,parameter  :: TEST            = 24 ! look down the number assigned for each test
...
!____________________________________
  ...
  ! max values of
    ...
    doubleprecision,parameter                   :: CFL  = 0.05d0

    doubleprecision,parameter                   :: Delt = CFL *  min(Delx, Dely)

    ! Adiabatic index

    doubleprecision,parameter :: gamma = 4.d0/3.d0 ! 5.d0/3.d0 ! 2.d0 !      monatomic gas    !  diatomic gas  !  !cp/cv  !
...
!!$    doubleprecision :: sigma_0  = 1.d6  
    ...
    doubleprecision,parameter :: kappa = 1.d0
    doubleprecision,parameter :: kappa_psi = 1.d3   ! clean divergence factor divE
    doubleprecision,parameter :: kappa_phi = 1.d1   ! clean divergence factor divB
...
!!$    doubleprecision,parameter :: B0    =  1.1547d0 !0053838d0
   ...
   ! ------------------
    ...
    !   Simulation domine
    doubleprecision,parameter ::  Lr       =  1.d0 !6.d0     !100.d0  !
    ...
    doubleprecision,parameter ::  Lx       =  40.d0 * a_tm    !200.d0   !
    doubleprecision,parameter ::  Ly       =  2.d0 * pi / k_tm !0.9975d0 !20.d0 !
    ...
    doubleprecision,parameter :: B0        =  1.d0   !1.d0 !sqrt(sigma_m * rho_up)
    doubleprecision,parameter :: P_up      =  1.d0   !theta * rho_up !multiply by constant 5 ?
    ...
    !   Conductivity
    doubleprecision,parameter :: sigma_0   =  1.d6 !S_l/(Lr * VA_rec_tearing) !
