module parameters
    ...
    integer,parameter  :: TEST            = 2  ! look down the number assigned for each test
...
!____________________________________
  ...
  !     NewRaph ---> nr
    ...
    doubleprecision,parameter :: B0        =  1.1547d0 !
    ...
    doubleprecision,parameter :: beta_m    =  0.d0 !2.d0 * P0 / B0**2


    !   Alfven Velocity

    doubleprecision,parameter :: VA_rec         =  0.d0 !sqrt(sigma_m/(1 + sigma_m))                    !Zenitani et al. (2010) (used in reconnection)

    doubleprecision,parameter :: VA_rec_tearing =  0.d0 !1.d0/sqrt(1.d0 + 2.d0 * beta_m + 1.d0/sigma_m) ! DelZana et al. (2016) Eq.(18) (used in RDTM)
    ...
    doubleprecision,parameter :: theta     =  0.0d0
    ...
    doubleprecision,parameter                   :: Delt_glb = 5.d-1  !
    doubleprecision,parameter                   :: Delt_loc = 1.d0   !
