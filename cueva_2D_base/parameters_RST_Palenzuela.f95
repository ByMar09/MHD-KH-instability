module parameters
    ...
    integer,parameter  :: TEST            = 3  ! look down the number assigned for each test
    ...
    integer,parameter  :: low_vel                    = 1  ! use 1 for low velocities approximation in recovery primitive variables and 0 for NOT (only in CARDANO)
    ...
    integer,parameter  :: change_time_step  = 1  ! use 1 for YES change the time step or 0 for NOT
...
!____________________________________
  ...
  !     NewRaph ---> nr
    ...
    doubleprecision,parameter :: rho_up    =  1.0d0
    ...
    doubleprecision,parameter :: sigma_0   =  1.d4 !( 1.d0 / (a_tm * VA_rec_tearing) ) * (pi * modes / b_rdtm)**(10.d0 / 3.d0)
    ...
    doubleprecision,parameter ::  k_tm     =  2.d0 * pi / Ly
    ...
    doubleprecision           :: sum_q, sum_p, sum_rho, sum_D, sum_D_med,max_val_v_va
    ...
    doubleprecision,parameter                   :: CFL   = 0.0001d0
    ...
    doubleprecision,parameter :: alpha_psi = Delx !1.d0
    doubleprecision,parameter :: alpha_phi = Delx !1.d0
