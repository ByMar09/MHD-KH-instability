...
!____________________________________
  ...
  !     NewRaph ---> nr
    ...
    doubleprecision,parameter ::  k_tm     =  10.d0
    doubleprecision,parameter ::  k_x      =  100.d0 * pi
    doubleprecision,parameter ::  k_y      =  100.d0 * pi
    doubleprecision,parameter ::  kap_tm   =  k_tm * a_tm
    doubleprecision,parameter ::  Lx       =  2.d-2 !2.d0 * pi / k_tm !40.d0 * a_tm    !200.d0   !
    doubleprecision,parameter ::  Ly       =  1.d2  !2.d0 * pi / k_tm !0.9975d0 !20.d0 !
...
!!$    doubleprecision :: sigma_0  = 1.d6  
    ...
    doubleprecision,parameter :: kappa     = 1.d2
    doubleprecision,parameter :: kappa_psi = 1.d2   ! clean divergence factor divE
    doubleprecision,parameter :: kappa_phi = 1.d2   ! clean divergence factor divB
