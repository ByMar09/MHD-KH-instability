module parameters
    ...
    integer,parameter  :: TEST            = 33 ! look down the number assigned for each test
    integer,parameter  :: BOUND           = 6  ! use 1 for copy boundary, 2 for periodic, 3 for reconnection special case, and 4 perfect conductor TM
    ...
    integer,parameter  :: flux_solver     = 7  ! use 1 for Simpler Lax-Friederich, 2 for HLL flux solver, 3 for HLLC_1, 4 for HLLC_2 , 5 for HLL + MP9 or MP5, 6 for HLLC_1 + MP5 and 7 HLLC_2 + MP9 or MP5
    ...
    integer,parameter  :: rec_mp          = 2  ! use 2 for MP9 1 for MP7 and 0 for MP5 spatial reconstruction in HLL or HLLC flux solvers
    ...
    integer,parameter  :: REC_4VECTOR     = 1  ! use 1 for reconstruction of velocity four-vector and 0 for NOT
...
!____________________________________
  ...
  !     NewRaph ---> nr
    ...
    integer, parameter :: hmax  = 501 !38401
    ...
    ! -----------------
    !   Conductivity
    doubleprecision,parameter :: sigma_0   =  1.22474d5
    ...
    doubleprecision,parameter :: B0        =  sqrt(10.d0)
    doubleprecision,parameter :: V0        =  0.d0 
    doubleprecision,parameter :: P_up      =  B0**2/10.d0
    doubleprecision,parameter :: P0        =  B0**2/10.d0
    ...
    doubleprecision,parameter :: VA_rec_tearing =  1.d0/sqrt(1.d0 + 2.d0 * beta_m + 1.d0/sigma_m) ! DelZana et al. (2016) Eq.(18) (used in RDTM)
    ...
    doubleprecision,parameter ::  k_tm     =  2.5d0
    doubleprecision,parameter ::  kap_tm   =  k_tm * a_tm

    doubleprecision,parameter ::  Lx       =  80.d0 * a_tm 
    doubleprecision,parameter ::  Ly       =  2.d0 * pi / k_tm   !(2.d0 * pi * a_tm * a_rdtm * S_a**( 3.d0/ 20.d0)) / b_rdtm !2.d0 * pi / k_tm ! 2.d0 * pi * a_tm / k_tm 
    ...
    doubleprecision,parameter ::  S_l      =  ( pi / b_rdtm )**(29.d0/6.d0)
    ...
    doubleprecision,parameter :: gamma = 4.d0/3.d0 !  5.d0/3.d0 !      monatomic gas    !  diatomic gas  !  !cp/cv  ! 2.d0 !
    ...
    doubleprecision  :: s1 = -5.d0
    doubleprecision  :: s2 =  5.d0
    ...
    doubleprecision,parameter                   :: Delt_glb = Delt         !0.01d0
    doubleprecision,parameter                   :: Delt_loc = 10.d0 * Delt !1.0d0
    integer,        parameter                   :: hglb     = ceiling(Delt_glb/Delt)
    integer,        parameter                   :: hloc     = floor(Delt_loc/Delt)

    
    ! Scalar hyperbolic divergence cleaning

    doubleprecision,parameter :: alpha_psi = 15.d0
    doubleprecision,parameter :: alpha_phi = 15.d0
