module parameters
    ...
    integer,parameter  :: TEST            = 8 ! look down the number assigned for each test
    ...
    integer,parameter  :: flux_solver     = 5  ! use 1 for Simpler Lax-Friederich, 2 for HLL flux solver, 3 for HLLC_1, 4 for HLLC_2 , 5 for HLL + MP9 or MP5, 6 for HLLC_1 + MP5 and 7 HLLC_2 + MP9 or MP5
    ...
    integer,parameter  :: conserved_to_primitive     = 0  ! use 1 for CARDANO solver and 0 for NEWTON-RAPHSON solver
...
!____________________________________
  ...
  !     NewRaph ---> nr
    ...
    doubleprecision,parameter :: B0        =  1.d-2
    ...
    doubleprecision,parameter :: gamma = 2.d0 ! 4.d0/3.d0 !  5.d0/3.d0 !
