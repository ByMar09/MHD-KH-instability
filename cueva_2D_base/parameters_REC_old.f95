module parameters
    ...
    integer,parameter  :: TEST            = 30 ! look down the number assigned for each test
    integer,parameter  :: BOUND           = 3  ! use 1 for copy boundary, 2 for periodic, 3 for reconnection special case, and 4 perfect conductor TM
...
!____________________________________
  ...
  !     NewRaph ---> nr
    ...
    integer, parameter :: hmax  = 307971 ! until time 60
    ...
    !   Magnetization
    doubleprecision,parameter :: sigma_m   =  0.05d0 
    ...
    doubleprecision,parameter :: P_up      =  theta * rho_up 
    ...
    !   Linquist Number                                                                                                                                                                                            
    doubleprecision,parameter ::  S_l      =  904.53d0 !1.d3 
    ...
    !   Simulation domine                                                                                                                                                                                          
    doubleprecision,parameter ::  Lr       =  3.0d0

    
    ! -----------------
    !   Conductivity

    doubleprecision,parameter :: sigma_0   =  S_l/(Lr * VA_rec) 
    ...
    !   Simulation domine                                                                                                                                                                                          
!    doubleprecision,parameter ::  Lr       =  1.5d0
    doubleprecision,parameter ::  a_tm     =  sqrt(Lr/(sigma_0 * VA_rec)) ! idem que --> S_l**(-1.d0/2.d0) * Lr ! OJO CAMBIAR EXPONENTE PARA REC, en especial (interesante) usar Sl**(-1./3.)
    ...
    doubleprecision,parameter ::  Lx       =  0.9975d0 !15.d0 * a_tm !OJO CAMBIAR PARA REC
    doubleprecision,parameter ::  Ly       =  2.d0  * Lr   !Longitud de la caja dos veces longitud de reconexion
   ...
   !   Linquist Number Sa
    ...
    doubleprecision,parameter                   :: Delt_loc = 0.5d0
