...
!*
      doubleprecision, parameter :: b1 = 1.d0/60.d0, b2 = 4.d0/3.d0, epsm = 1.d-10, alpha_mp = 2.d0 !   alpha_mp = 1.d0/3.d0 ! original alpha_mp =2.d0 
...
!*        Original (unlimited) "left" interface value at i+1/2 (SH97; Eq. 2.1)
            vorp(imp,jmp,imp5) = b1*( 2.d0 * u(imp-2,jmp,imp5) - 13.d0 * u(imp-1,jmp,imp5) + 47.d0 * u(imp,jmp,imp5) &
                                   + 27.d0 * u(imp+1,jmp,imp5) - 3.d0  * u(imp+2,jmp,imp5) )
!*        Original (unlimited) "right" interface value at i-1/2 (mirror of Eq. 2.1)
            vorm(imp,jmp,imp5) = b1*(-3.d0 * u(imp-2,jmp,imp5) + 27.d0 * u(imp-1,jmp,imp5) + 47.d0 * u(imp,jmp,imp5) &
                                   - 13.d0 * u(imp+1,jmp,imp5) + 2.d0  * u(imp+2,jmp,imp5) )
